interface BriefCaseDuoToneBlackProps {
    width?: number
    height?: number
    className?: string
}

export const BriefCaseDuoToneBlack = ({ width = 24, height = 24, className }: BriefCaseDuoToneBlackProps) => {
    return (
        <svg
            width={width}
            height={height}
            ...
            className={className}
        >
            <rect x="2" y="5" width="20" height="17" rx="3" fill="#5E4AE3" />
            <rect x="10" y="12" width="4" height="2" rx="1" fill="#9884ED" />
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
