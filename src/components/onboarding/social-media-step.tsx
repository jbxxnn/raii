  ...
  return (
    <Card className="w-[500px] p-4">
      <CardHeader className="text-center mb-4">
        <CardTitle className="text-3xl font-bold">One last thing 🙏</CardTitle>
        ...
        <div className="grid grid-cols-3 gap-4">
          {socialPlatforms.map((platform) => (
            <div
              key={platform.id}
              className={`
                p-4 rounded-xl border text-center space-y-2 transition-all duration-200
              ...
              `}
              onClick={() => {
                if (platform.strategy === 'INSTAGRAM' && platform.status === 'not_connected') {
